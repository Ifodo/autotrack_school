...
const Home = ({ sideBarToggle }) => {
    return (
        ...
        <div className={`${sideBarToggle ? " ml-0 " : " ml-64 "}`}>
            {<div className="bg-gray-500 h-[calc(100vh-114px)] w-full dark:bg-gray-700 flex justify-center">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:py-24 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-4 mt-4">
                        <div className="bg-white overflow-hidden shadow sm:rounded-lg dark:bg-gray-900 h-[20vh]">
                            <div className="px-4 py-5 sm:p-6">
                                <dl>
                                    <dt className="text-sm leading-5 font-medium text-gray-500 truncate dark:text-gray-400">
                                        Number of Parents</dt>
            ...
            {/* <div className="h-[calc(100vh-114px)] bg-black">
                    ...
                    <div class="block rounded-xl border border-gray-800 p-4">
                        <span class="inline-block rounded-lg p-3">
                            <div class="inline-flex align-middle justify-center items-center select-none text-white">
                                <svg viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" height="128" width="128">
            ...
            <footer class="bg-gray-800 text-white py-4">
                <div class="container mx-auto text-center">
                    <p>&copy; 2024 Autotrack solutions.</p>
                </div>
            </footer>
        </div>
